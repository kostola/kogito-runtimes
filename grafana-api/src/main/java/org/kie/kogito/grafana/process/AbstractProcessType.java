...
public class AbstractProcessType {
    ...
    public AbstractProcessType(Class internalRepresentationClass, String processType) {
        this(internalRepresentationClass, processType, "");
    }

    public AbstractProcessType(Class internalRepresentationClass, String processType, String nameSuffix) {
